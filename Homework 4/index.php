...
$jobs = [
    [
        ...
        "description" => "The description of working as a software developer",
    ],
    [
        "name" => "Hobo",
        "dateStart" => "January 2010",
        "dateEnd" => "January 2015",
        "description" => "The description of living as a homeless person",
    ],
    [
        "name" => "Prsident of Colombia",
        "dateStart" => "January 2000",
        "dateEnd" => "January 2010",
        "description" => "The description of totalitarian rulage of the country",
    ],
];
?>
  ...
  <div class="w3-content w3-margin-top" style="max-width:1400px;">
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <?php for ($job = 0; $job < count($jobs); $job++): ?>
            <div class="w3-container">
                <h5 class="w3-opacity"><b><?= $jobs[$job]['name']; ?>  </b></h5>
